    ...
    public class GamesWithReviewsDto {
        ...
        public GamesWithReviewsDto() {
        }

        public GamesWithReviewsDto(String title, String description, String developer, String releaseDate, double rating, List<GenresNameDto> genres, List<ReviewsDto> reviews) {
            this.title = title;
